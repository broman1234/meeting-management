...
<html>
    ...
    <#include 'top.ftl'>
                    ...
                    <fieldset>
                        ...
                        <table class="formtable">
                            <tr>
                                <td>姓名：</td>
                                <td>
                                    <input name="employeename" type="text" id="employeename" value="<#if employee??>${employee.employeename!''}</#if>" maxlength="20"/>
                                </td>
                                <td>账号名：</td>
                                <td>
                                    <input name="username" type="text" id="accountname" value="<#if employee??>${employee.username!''}</#if>" maxlength="20"/>
                                </td>
                                <td>状态：</td>
                                <td>
                                    <#if employee??>
        ...
        <div class="page-footer">
            <hr/>
            更多问题，欢迎联系<a href="mailto:manmo431@gmail.com">管理员</a>
